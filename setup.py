...
setup(name='django-qshop',
      ...
      packages=['qshop', 'qshop.templatetags', 'qshop.cart', 'qshop.management', 'qshop.management.commands', 'qshop.payment_vendors', 'qshop.payment_vendors.banktransfer', 'qshop.payment_vendors.paypal', 'qshop.payment_vendors.webmoney'],
